...
const shortcuts = [
  ...
  { action: 'Cut Map Element', keys: ['Ctrl', 'X'] },
  { action: 'Copy Map Element', keys: ['Ctrl', 'C'] },
  { action: 'Paste Map Element', keys: ['Ctrl', 'V'] },
  { action: 'Paste as Group', keys: ['Ctrl', 'Shift', 'V'] },
  { action: 'Duplicate Map Element', keys: ['Ctrl', 'D'] },
  ...
  { action: 'Nudge Layer Pose (Pose Adjuster focused)', keys: ['↑', '↓', '←', '→'] },
  { action: 'Rotate Layer Pose (Pose Adjuster focused)', keys: ['Q', 'or', 'E'] },
  { action: 'Nudge Step ×10 / ×0.1 (Pose Adjuster, Number Field)', keys: ['Shift', 'or', 'Alt'] },
  { action: 'Step Number Field Value', keys: ['↑', 'or', '↓'] },
