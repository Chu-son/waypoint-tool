...
const buttonVariants = cva(
  'inline-flex items-center justify-center font-medium transition-colors focus:outline-none focus:ring-2 disabled:opacity-50 disabled:pointer-events-none select-none',
  {
    variants: {
      variant: {
        primary:
          'bg-primary-base text-text-inverse hover:bg-primary-hover shadow-xs border border-primary-hover/30 focus:ring-primary-base/40',
        secondary:
          'bg-surface-panel border border-border-base text-text-base hover:bg-surface-hover hover:border-border-base/80 focus:ring-border-focus/40',
        outline:
          'border border-border-base bg-transparent text-text-base hover:bg-surface-hover hover:border-border-base/80 focus:ring-border-focus/40',
        ghost: 'bg-transparent text-text-muted hover:bg-surface-hover hover:text-text-base',
        danger:
          'bg-danger-base text-text-inverse hover:bg-danger-hover border border-danger-hover/30 shadow-xs focus:ring-danger-base/40',
